...
export default function Category(props) {
    ...
    async function apiCall(id){
        ...
        const {data} =await axios.get(CATEGORY_URL+`id=${id}`)
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm-bold text-gray-500">{val.coin1.current_price}</div>
                        <div className="text-sm-bold text-gray-500">{val.coin1.low_24h}</div>
                    </td>
              </tr>
              <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm-bold text-gray-500">{val.coin2.current_price}</div>
                        <div className="text-sm-bold text-gray-500">{val.coin2.low_24h}</div>
                    </td>
              </tr>
              <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm-bold text-gray-500">{val.coin3.current_price}</div>
                        <div className="text-sm-bold text-gray-500">{val.coin3.low_24h}</div>
                    </td>
              </tr>
              <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm-bold text-gray-500">{val.coin4.current_price}</div>
                        <div className="text-sm-bold text-gray-500">{val.coin4.low_24h}</div>
                    </td>
              </tr>
              <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm-bold text-gray-500">{val.coin5.current_price}</div>
                        <div className="text-sm-bold text-gray-500">{val.coin5.low_24h}</div>
                    </td>
              </tr>
              </tbody>
            </table>
